import fs from "fs"
import * as pdfjsLip from "pdfjs-dist/legacy/build/pdf.mjs"
...
export const analyseResume = async (req, res) => {
    try {
        ...
        const pdf = await pdfjsLip.getDocument({ data: uint8Array }).promise
...
`
        ...
        const questionsArray = parsed.questions.map(q => q.trim());
